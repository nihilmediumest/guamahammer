...
const unitsDB_kis = {
    ...
    "Kossars": {
        ...
        perfiles: [
            { nombre: "Kossar", stats: { M: 4, HA: 3, HP: 3, F: 3, R: 3, H: 1, I: 3, A: 1, L: 7 } },
    ...
    "Lanceros Gospodar": {
        ...
        reglasEspeciales: "Odio (Caos)",
        perfiles: [
            { nombre: "Lancero Gospodar", stats: { M: 4, HA: 3, HP: 3, F: 3, R: 3, H: 1, I: 3, A: 1, L: 7 } },
    ...
    "Cazadores": {
        ...
        options: [ { n: "Armas de mano adicionales", p: 1 }, { n: "Hachas arrojadizas", p: 1 } ],
    ...
    "Lanceros Alados": {
        ...
        perfiles: [
            { nombre: "Lancero Alado", stats: { M: 4, HA: 4, HP: 3, F: 3, R: 3, H: 1, I: 3, A: 1, L: 7 } },
    ...
    "Arqueros Ungol a Caballo": {
        ...
        reglasEspeciales: "Caballería rápida, Jinetes expertos, Odio (Caos), Arco compuesto Ungol (18\", F4, Disparo rápido)",
        perfiles: [
            { nombre: "Arquero Ungol", stats: { M: 4, HA: 3, HP: 3, F: 3, R: 3, H: 1, I: 3, A: 1, L: 7 } },
            { nombre: "Oficial", stats: { M: 4, HA: 3, HP: 3, F: 3, R: 3, H: 1, I: 3, A: 2, L: 7 } },
            { nombre: "Caballo de guerra", stats: { M: 8, HA: 2, HP: 0, F: 4, R: 3, H: 1, I: 2, A: 1, L: 5 } }
        ],
        options: [ { n: "Escudos", p: 1 } ],
    ...
    "Legión del Grifo": {
        ...
        perfiles: [
            { nombre: "Legionario del Grifo", stats: { M: 4, HA: 4, HP: 3, F: 4, R: 3, H: 1, I: 3, A: 1, L: 8 } },
    ...
    "Hermandad del Oso": {
        ...
        perfiles: [
            { nombre: "Hermano del oso", stats: { M: 4, HA: 4, HP: 4, F: 3, R: 4, H: 1, I: 3, A: 1, L: 8 } },
            { nombre: "Oficial", stats: { M: 4, HA: 4, HP: 4, F: 3, R: 4, H: 1, I: 3, A: 2, L: 8 } },
            { nombre: "Caballo de guerra", stats: { M: 8, HA: 2, HP: 0, F: 4, R: 3, H: 1, I: 2, A: 1, L: 5 } }
        ],
        options: [ { n: "Hachas arrojadizas", p: 1 }, { n: "Escudos", p: 1 } ],
        command: { c: { n: "Oficial", p: 6 }, s: { n: "Portaestandarte", p: 6 }, m: { n: "Músico", p: 6 } },
        magicBanner: 50
    },
    "Druzinha": {
        ...
        perfiles: [
            { nombre: "Druzinha", stats: { M: 4, HA: 3, HP: 3, F: 3, R: 3, H: 1, I: 3, A: 1, L: 7 } },
            { nombre: "Oficial", stats: { M: 4, HA: 3, HP: 4, F: 3, R: 3, H: 1, I: 3, A: 2, L: 7 } },
            { nombre: "Caballo de guerra", stats: { M: 8, HA: 2, HP: 0, F: 4, R: 3, H: 1, I: 2, A: 1, L: 5 } }
        ],
        command: { c: { n: "Oficial", p: 6 }, m: { n: "Músico", p: 6 } }
    ...
    "Círculo Interior de la Legión del Grifo": {
        ...
        perfiles: [
            { nombre: "Caballero del Círculo Interior", stats: { M: 4, HA: 4, HP: 3, F: 4, R: 3, H: 1, I: 4, A: 1, L: 8 } },
            { nombre: "Oficial", stats: { M: 4, HA: 4, HP: 3, F: 4, R: 3, H: 1, I: 4, A: 2, L: 8 } },
            { nombre: "Caballo de guerra con barda", stats: { M: 8, HA: 2, HP: 0, F: 4, R: 3, H: 1, I: 2, A: 1, L: 5 } }
        ],
    ...
    "Bardiches": {
        ...
        reglasEspeciales: "Odio (Caos), Bardiche (se puede usar como Arma a dos manos o como alabarda si no han movido)",
        perfiles: [
            { nombre: "Guerrero Bardiche", stats: { M: 4, HA: 4, HP: 3, F: 3, R: 3, H: 1, I: 4, A: 1, L: 8 } },
    ...
    "Guardia Gospodar": {
        ...
        perfiles: [
            { nombre: "Guerrero Guardia Gospodar", stats: { M: 4, HA: 4, HP: 3, F: 4, R: 3, H: 1, I: 4, A: 1, L: 8 } },
            { nombre: "Oficial", stats: { M: 4, HA: 4, HP: 3, F: 4, R: 3, H: 1, I: 4, A: 2, L: 8 } }
        ],
        options: [ { n: "Escudos", p: 1 } ],
        command: { c: { n: "Oficial", p: 6 }, s: { n: "Portaestandarte", p: 6 }, m: { n: "Músico", p: 6 } },
    ...
    "Señor de las Bestias": {
        ...
        min: 1,
        max: 1,
        equipo: "El Señor de las bestias: dos armas de mano y armadura ligera. Bestias: garras y dientes.",
        reglasEspeciales: "Veloz, Odio (Caos), Hostigador, Unidad mixta",
        perfiles: [
            { nombre: "Señor de las bestias", stats: { M: 4, HA: 4, HP: 4, F: 4, R: 4, H: 2, I: 4, A: 2, L: 8 } },
            { nombre: "Lobo invernal", stats: { M: 9, HA: 4, HP: 0, F: 4, R: 4, H: 1, I: 4, A: 2, L: 6 } },
            { nombre: "Oso blanco kislevita", stats: { M: 6, HA: 4, HP: 0, F: 5, R: 5, H: 3, I: 2, A: 3, L: 6 } }
        ],
        composition: {
            type: "ratioBased",
    ...
    "Streltsi": {
        ...
        reglasEspeciales: "Odio (Caos)",
        perfiles: [
            { nombre: "Streltsi", stats: { M: 4, HA: 4, HP: 4, F: 3, R: 3, H: 1, I: 3, A: 1, L: 8 } },
            { nombre: "Oficial", stats: { M: 4, HA: 4, HP: 4, F: 3, R: 3, H: 1, I: 3, A: 2, L: 8 } }
        ],
        options: [ { n: "Escudos", p: 1 } ],
        command: { c: { n: "Oficial", p: 6 }, s: { n: "Portaestandarte", p: 6 }, m: { n: "Músico", p: 6 } },
        magicBanner: 50,
    ...
    "Carón": {
        ...
        reglasEspeciales: "Mortero (catapulta con plantilla redonda grande, F3, Poder de penetración; impacto central F6, Heridas múltiples 1D3, niega TSA; usa tabla problemas cañón)",
        perfiles: [
    ...
    "Gran Cañón Urugán": {
        ...
        max: 1,
        equipo: "La dotación: arma de mano.",
        reglasEspeciales: "Dispara como Batería de cohetes (catapulta con plantilla redonda pequeña, F5, Poder de penetración; impacto central F8, niega TSA, Heridas múltiples 1D6; usa tabla problemas lanzallamas)",
        perfiles: [
            { nombre: "Gran cañón Urugán", stats: { M: "-", HA: "-", HP: "-", F: "-", R: 7, H: "-", I: "-", A: "-", L: "-" } },
            { nombre: "Dotación (3)", stats: { M: 4, HA: 3, HP: 3, F: 3, R: 3, H: 1, I: 3, A: 1, L: 7 } }
        ]
    },
    "Hijos de Ursun": {
        ...
        max: 5,
        equipo: "Arma de mano, Lanza de caballería, Armadura pesada y Escudo.",
        reglasEspeciales: "Inmunes a la psicología, Odio (Caos), Causan Miedo, Inflamables, Seguidos por el invierno (-1/2 I enemigos en contacto)",
        perfiles: [
            { nombre: "Hijo de Ursun", stats: { M: 4, HA: 4, HP: 3, F: 4, R: 3, H: 1, I: 4, A: 1, L: 8 } },
            { nombre: "Oficial", stats: { M: 4, HA: 4, HP: 3, F: 4, R: 3, H: 1, I: 4, A: 2, L: 8 } },
            { nombre: "Oso blanco kislevita", stats: { M: 6, HA: 4, HP: 0, F: 5, R: 5, H: 3, I: 2, A: 3, L: 6 } }
        ],
    ...
    "Comandante Kislevita": {
        ...
        perfiles: [ { nombre: "Comandante kislevita", stats: { M: 4, HA: 6, HP: 6, F: 4, R: 4, H: 3, I: 6, A: 4, L: 9 } } ],
        options: [ 
            { n: "Arma de mano adicional", p: 2 }, { n: "Arma a dos manos", p: 4 }, { n: "Alabarda", p: 5 }, 
            { n: "Lanza", p: 3 }, { n: "Lanza de caballería", p: 6 }, { n: "Pistola", p: 5 }, 
            { n: "Ristra de pistolas", p: 10 }, { n: "Arco", p: 5 }, { n: "Escudo", p: 3 },
            { n: "Armadura pesada", p: 3 }
        ],
        mounts: ["Caballo de guerra", "Caballo de guerra con barda", "Oso blanco kislevita"],
        maxMagicItems: 2,
        maxRelics: 1
    },
    "Hija de Miska": {
        ...
        min: 1, max: 1,
        equipo: "Arma de mano",
        reglasEspeciales: "Odio (Caos), Immune a psicología, Resistencia mágica (1), Icono legendario (unidades kislevitas a 12-18\" son Inmunes a psicología)",
        perfiles: [ { nombre: "Hija de Miska", stats: { M: 4, HA: 5, HP: 4, F: 4, R: 4, H: 3, I: 5, A: 3, L: 8 } } ],
        options: [ 
            { n: "Arma a dos manos", p: 4 }, { n: "Lanza", p: 2 }, { n: "Arma de mano adicional", p: 3 }, 
            { n: "Arco", p: 5 }
        ],
        mounts: ["Caballo de guerra", "Caballo de guerra con barda", "Dragón blanco"],
        maxMagicItems: 2,
        maxRelics: 1,
    ...
    "Gran Maga de Hielo": {
        ...
        perfiles: [ { nombre: "Gran Maga de Hielo", stats: { M: 4, HA: 3, HP: 3, F: 3, R: 4, H: 3, I: 4, A: 1, L: 8 } } ],
        options: [ 
            { n: "Arma de mano adicional", p: 2 }, { n: "Arma a dos manos", p: 4 },
    ...
    "Boyardo": {
        ...
        equipo: "Arma de mano y Armadura ligera.",
        reglasEspeciales: "Odio (Caos), Jinete experto (si va montado en caballo)",
        perfiles: [ { nombre: "Boyardo", stats: { M: 4, HA: 5, HP: 5, F: 4, R: 4, H: 2, I: 5, A: 3, L: 8 } } ],
        options: [ 
            { n: "Arma de mano adicional", p: 1 }, { n: "Arma a dos manos", p: 2 }, { n: "Alabarda", p: 3 }, 
            { n: "Lanza", p: 2 }, { n: "Lanza de caballería", p: 4 }, { n: "Pistola", p: 5 }, 
            { n: "Ristra de pistolas", p: 10 }, { n: "Arco largo", p: 5 }, { n: "Escudo", p: 2 },
    ...
    "Maga de Hielo": {
        ...
        equipo: "Arma de mano.",
        reglasEspeciales: "Odio (Caos), Jinete experta",
        perfiles: [ { nombre: "Maga de Hielo", stats: { M: 4, HA: 3, HP: 3, F: 3, R: 3, H: 2, I: 3, A: 1, L: 7 } } ],
        options: [ 
            { n: "Arma de mano adicional", p: 1 }, { n: "Arma a dos manos", p: 2 },
    ...
    "Sacerdote Guerrero": {
        ...
        min: 1, max: 1,
        equipo: "Arma de mano y Armadura ligera.",
        reglasEspeciales: "Immune a la psicología, Inspirador (unidad a la que se une será Immune a psicología)",
        perfiles: [ { nombre: "Sacerdote guerrero", stats: { M: 4, HA: 4, HP: 4, F: 4, R: 4, H: 2, I: 4, A: 2, L: 8 } } ],
        options: [ 
            { n: "Arma de mano adicional", p: 1 }, { n: "Arma a dos manos", p: 2 }, { n: "Escudo", p: 2 },
            { n: "Arco", p: 4 }, { n: "Hachas arrojadizas", p: 2 }, { n: "Armadura pesada", p: 2 }
        ],
        mounts: ["Caballo de guerra", "Caballo de guerra con barda"],
        maxMagicItems: 2,
        plegarias: "Conoce todas las Plegarias, puede lanzar una por fase con Nivel de energía 3"
    },
    "Atamán": {
        faction: "kis",
        foc: "Hero",
        ...
        min: 1, max: 1,
        equipo: "Arma de mano y Arco Compuesto Ungol.",
        reglasEspeciales: "Odio (Caos), Jinete experto, Caballería rápida, Inmunes al Pánico (él y arqueros Ungol a los que se una)",
        perfiles: [ 
            { nombre: "Atamán", stats: { M: 4, HA: 4, HP: 6, F: 4, R: 4, H: 2, I: 6, A: 3, L: 8 } },
            { nombre: "Caballo de guerra", stats: { M: 8, HA: 2, HP: 0, F: 4, R: 3, H: 1, I: 2, A: 1, L: 5 } }
        ],
        options: [ { n: "Armadura ligera", p: 3 }, { n: "Escudo", p: 2 } ],
        maxMagicItems: 1
    },
    "Bruja Ungol": {
        faction: "kis",
        ...
        min: 1, max: 1,
        equipo: "Arma de mano.",
        reglasEspeciales: "Odio (Caos), Jinete experta, Protectora de almas (RM1, RM2 vs Caos/Nigromancia), Tribus del norte (sólo se une a arqueros Ungol montados), Causa Miedo",
        perfiles: [ { nombre: "Bruja Ungol", stats: { M: 4, HA: 3, HP: 3, F: 3, R: 3, H: 2, I: 3, A: 1, L: 8 } } ],
        options: [ 
            { n: "Arma de mano adicional", p: 1 }, { n: "Arma a dos manos", p: 2 },
            { n: "Nivel de Magia 2", p: 35 }
        ],
