// Guamahammer Army File: cvstr
// Generated by Admin Editor @ 2025-11-07T12:06:27.616Z
...
const unitsDB_cvstr = {
    ...
    "options": [
      {
        ...
        "p": 0,
        "summary": "Tamaño unidad 5-20, no pueden llevar estandarte.",
        "exclusiveGroup": "formation"
      },
      {
        "n": "Formación (Carga Devastadora)",
        "p": 0,
        "summary": "Tamaño unidad 10-30. Ganan +1F al cargar.",
        "exclusiveGroup": "formation"
      }
    ],
    "command": {
      ...
      "s": {
        "n": "Portaestandarte",
        "p": 6,
        "restrictionText": "No si son Hostigadores"
      },
      "m": {
        "n": "Músico",
        "p": 6
  ...
  "Esqueletos": {
    ...
    "options": [
      ...
      },
      {
        ...
        "p": 2,
        "restrictionText": "Hasta la mitad de las unidades de esqueletos."
      },
      {
        "n": "Convertir en Tiradores Esqueleto",
        "p": 2,
        "summary": "Gana Arco, +1HP.",
        "restrictionText": "Hasta la mitad de las unidades de esqueletos."
      },
      {
        "n": "Sustituir arcos por Ballestas",
        "p": 2,
        "summary": "Sólo Tiradores."
      }
    ],
    "command": {
      "c": {
  ...
  "Striganos": {
    ...
    "options": [
      ...
      {
        "n": "Mejorar con Emboscada",
        "p": 2,
        "restrictionText": "Una única unidad por ejército."
      }
    ],
    "command": {
      "c": {
  ...
  "Corte del Rey": {
    ...
    "champSkills": {
      "limit": 1,
      "type": "count",
      "skillSource": "Poderes Vampíricos Strigoi"
    }
  },
  "Lobos Siniestros": {
    "faction": "cvstr",
    ...
    "options": [
      {
        "n": "Infestado",
        "p": 15,
        "summary": "Explota F2 3D6 imp al morir."
      },
      {
    ...
    "options": [
      {
        "n": "Pellejo férreo",
        "p": 2,
        "summary": "Piel escamosa (5+)."
      },
      {
        "n": "Frenesí horrendo",
        "p": 2,
        "summary": "Carga devastadora."
      }
    ],
    "command": {
      "c": {
  ...
  "Señor de Vampiros Strigoi": {
    ...
    "perfiles": [
      {
        "nombre": "Señor de Vampiros Strigoi",
        "stats": {
          "M": 6,
          "HA": 7,
          "HP": 3,
...
const armySkillsDB_cvstr = {
  "Odio eterno": {
    "points": 0,
    "faction": "cvstr",
    "type": "Poder Vampírico Strigoi",
    "summary": "Odio (todos los enemigos). (Gratis y obligatorio)"
  },
  "Furia de Strigos": {
    "points": 10,
    "faction": "cvstr",
    "type": "Poder Vampírico Strigoi",
    "summary": "Furia asesina."
  },
  "Cazador en la oscuridad": {
    "points": 15,
    "faction": "cvstr",
    "type": "Poder Vampírico Strigoi",
    "summary": "Explorador (solo infantería)."
  },
  "Horror sobrenatural": {
    "points": 20,
    "faction": "cvstr",
  ...
  "Pellejo férreo": {
    ...
    "faction": "cvstr",
    "type": "Poder Vampírico Strigoi",
    "summary": "Piel escamosa (4+)."
  },
  "Ferocidad imparable": {
    "points": 15,
    "faction": "cvstr",
    "type": "Poder Vampírico Strigoi",
    "summary": "Impactos por carga (1) y Carga devastadora."
  },
  "Veneno necrótico": {
    "points": 20,
    "faction": "cvstr",
    "type": "Poder Vampírico Strigoi",
    "summary": "Ataques envenenados hieren con 5+. Heridas auto son Heridas múltiples (2)."
  },
  "Fuerza imparable": {
    "points": 20,
    "faction": "cvstr",
    "type": "Poder Vampírico Strigoi",
    "summary": "Heridas múltiples (1D3) en CaC."
  },
  "Músculos de acero": {
    "points": 20,
    "faction": "cvstr",
  ...
  "Curación rápida": {
    ...
    "faction": "cvstr",
    "type": "Poder Vampírico Strigoi",
    "summary": "Regeneración (5+)."
  },
  "Celeridad de ultratumba": {
    "points": 25,
    "faction": "cvstr",
    "type": "Poder Vampírico Strigoi",
    "summary": "Esquivar (5+)."
  ...
  "Presencia perturbadora": {
    ...
    "faction": "cvstr",
    "type": "Poder Vampírico Strigoi",
    "summary": "-1 impactar al personaje en CaC."
  },
  "La encarnación del miedo": {
    "points": 25,
    "faction": "cvstr",
    "type": "Poder Vampírico Strigoi",
    "summary": "Enemigo repite chequeos superados de Miedo/Terror causados por personaje."
  },
  "Aullido de mando": {
    "points": 25,
    "faction": "cvstr",
    "type": "Poder Vampírico Strigoi",
    "summary": "Portahechizos(1D3+1). Unidad Necrófago/Strigano (12\") mueve 1D6+2\", puede cargar."
  },
  "Forma de murciélago": {
    "points": 30,
    "faction": "cvstr",
  ...
  "Insensible": {
    ...
    "faction": "cvstr",
    "type": "Poder Vampírico Strigoi",
    "summary": "-1 herir contra personaje (no afecta impactos sin F)."
  },
  "Llamar a los necrófagos": {
    "points": 35,
    "faction": "cvstr",
    "type": "Poder Vampírico Strigoi",
    "summary": "Invocación Nehek/Animar Muertos puede invocar Necrófagos/Striganos (1D6-1 por dado, no sobre máx)."
  },
  "Señor de los necrófagos": {
    "points": 45,
    "faction": "cvstr",
    "type": "Poder Vampírico Strigoi",
    "summary": "Sólo Señor Vampiros. Necrófagos del ejército ganan Vanguardia."
  },
  "Vitalidad impía": {
    "points": 45,
    "faction": "cvstr",
    "type": "Poder Vampírico Strigoi",
    "summary": "Sólo Señor Vampiros. Regeneración (4+)."
  },
  "Monstruo descomunal": {
    "points": 50,
    "faction": "cvstr",
    "type": "Poder Vampírico Strigoi",
    "summary": "Sólo Señor Vampiros. Infantería Monstruosa (40x40). +1F, +1R, +1H, Terror. -1I."
  }
};
